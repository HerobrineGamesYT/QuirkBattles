...
public class DetroitSmashAbility extends Ability {
    ...
    public void circleEffect(Location loc, float radius) {
        for (double t = 0; t < 1000; t += 0.5) {
            ...
            PacketPlayOutWorldParticles packet = new PacketPlayOutWorldParticles(EnumParticle.BLOCK_CRACK, true, (float) loc.getX() + x, (float) loc.getY(), (float) loc.getZ() + z, 0, 0, 0, 0, 1, 3);
