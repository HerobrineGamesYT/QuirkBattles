...
public class HowitzerImpactAbility extends Ability {
    ...
    public void doAbility(Player player) {
        ...
        doExplosionCollisonForHowitzer(loc, 2f, 10, player);
        new BukkitRunnable() {
            int maxExplosions = 3;
            ...
            public void run() {
                ...
                if (ticks % 10 == 0 && explosionCount < maxExplosions) {
                    player.getLocation().getWorld().createExplosion(player.getLocation().getX(), player.getLocation().getY(), player.getLocation().getZ(), 2f, false, false);
