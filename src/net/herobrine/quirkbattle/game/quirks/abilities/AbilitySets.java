...
public enum AbilitySets {
    ...
    public final boolean useTemperature;
    public final int tempPerSecond;

    AbilitySets(Abilities[] abilities, boolean useTemperature, int tempPerSecond) {
    ...
    public int getTempPerSecond() {
        return tempPerSecond;
    }
